        ...
        const categoryScore = parseFloat(results.gestures[0][0].score * 100).toFixed(2);
                ...
                switch (categoryName) {
                    ...
                    case "wrong":
                        ...
                        break;
                    default:
                        gestureCategory = "无关手势";
                        break;
                }
        p.innerText = `当前手势: ${gestureCategory}\n 置信度: ${categoryScore}%\n`;
        p.style =
            "left: 0px;" +
                "top: " +
                event.target.height +
...
function enableCam(event) {
    ...
    if (webcamRunning === true) {
        ...
        webcamRunning = true;
        enableWebcamButton.innerText = "结束识别";
    }
...
async function predictWebcam() {
    ...
    if (results.gestures.length > 0) {
        ...
        let accuracyPercentage = (accuracy * 100).toFixed(2) + "%";
        gestureOutput.innerText = `当前手势: ${gestureCategory}\n 置信度: ${categoryScore} %\n 正确率: ${accuracyPercentage} `;
    }
    else {
        gestureOutput.style.display = "无关手势";
    }
